...
public class Translator {
    ...
    public void bexpr(int bexpr_false){
        if(look.tag == Tag.RELOP){
            ...
            expr();
            switch(relop_sign){
                case "==" : code.emit(OpCode.if_icmpne, bexpr_false); break;
                case "<=" : code.emit(OpCode.if_icmpgt, bexpr_false); break;
                case "<" : code.emit(OpCode.if_icmpge, bexpr_false); break;
                case ">=" : code.emit(OpCode.if_icmplt, bexpr_false); break;
                case ">" : code.emit(OpCode.if_icmple, bexpr_false); break;
                case "<>" : code.emit(OpCode.if_icmpeq, bexpr_false); break;
